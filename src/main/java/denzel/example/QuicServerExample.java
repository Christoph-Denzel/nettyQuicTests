        ...
        ChannelHandler codec = new QuicServerCodecBuilder().sslContext(context)
                ...
                .handler(new ChannelInboundHandlerAdapter() {
                    ...
                    public void channelRegistered(ChannelHandlerContext ctx) {
                        ...
                        System.out.println("Channel registered thread: " + Thread.currentThread().getName());
                        System.out.println("Channel registered eventloop: " + channel.eventLoop());
                    }
                    ...
                    protected void initChannel(QuicStreamChannel ch)  {
                        ...
                        ch.pipeline().addLast(new LineBasedFrameDecoder(1024))
                            ...
                            public void channelRead(ChannelHandlerContext ctx, Object msg) {
                                ...
                                System.out.println("Message receive Thread: " + Thread.currentThread().getName());
                                System.out.println("Message receive eventloop: " + ctx.channel().eventLoop());
                                try {
